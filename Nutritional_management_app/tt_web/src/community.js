...
import { collection, getDocs, doc, setDoc, updateDoc, arrayUnion, query, where, orderBy, startAfter, limit, getDoc } from "firebase/firestore";
...
function Community() {
 ...
 //게시글 클릭
  ...
  const handleLike = async () => {
    ...
    await increaseExperience(authorId, 5);
    fetchPosts();
  };
